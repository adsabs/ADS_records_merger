				...
				<collection>
					<xsl:for-each select="metadata">
						...
						<record>
							...
							<!-- Data Sources -->
					        <xsl:if test="data_sources">
								<xsl:for-each select="data_sources/data_source">
									<datafield tag="980" ind1="" ind2="">
							...
							<!-- Vizier Tables -->
					        <xsl:if test="vizier_tables">
								<xsl:for-each select="vizier_tables/vizier_table">
									<datafield tag="980" ind1="" ind2="">
