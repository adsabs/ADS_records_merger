MERGER_RULES = {
  ...
  'collaboration': 'priorityMerger',
  'collection': 'priorityMerger',
  'comment': 'takeAll',
  'conference_metadata': 'priorityMerger',
  'controlled keywords': 'takeAll',
  'copyright': 'priorityMerger',
  'creation and modification date': 'takeAll',
  'doi': 'priorityMerger',
  'facility telescope instrument': 'takeAll',
  'first author': 'authorMerger',
  'free keyword': 'takeAll',
  'identifiers': 'takeAll',
  'isbn' : 'takeAll',
  'issn' : 'takeAll',
  'journal': 'priorityMerger',
  'language code': 'priorityMerger',
  'link': 'priorityMerger',
  'number of pages': 'priorityMerger',
  'objects' : 'takeAll',
  'origin' : 'priorityMerger',
  'original title': 'titleMerger',
  'other author': 'authorMerger',
  'other journal': 'takeAll',
  'publication date': 'pubdateMerger',
  'references': 'referencesMerger',
  'system number': 'priorityMerger',
  'theses': 'takeAll',
